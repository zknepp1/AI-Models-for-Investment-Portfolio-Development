...
class Investment_Manager:
    ...
    def data_with_preds(self):
        ...
        for i in self.data_list:
          ...
          df.to_csv(data_path + t + '_complete_news_df.csv', index=False)
          df_list.append(df)
          count += 1
        return df_list
...
#          lp_problem += shares_to_buy[ticker] * self.final_df.at[ticker, 'open'] <= max_concentration * total_budget
